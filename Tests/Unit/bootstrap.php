...
if (!file_exists($autoload)) {
    throw new \In2code\Femanager\Exception\FileNotFoundException('Can not find autoload path', 1579187349);
}
...
if ($bootstrapLoaded === false) {
    throw new \In2code\Femanager\Exception\FileNotFoundException(
