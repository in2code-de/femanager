...
class UserControllerTest extends UnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new TestableUserController(
            $this->userRepository,
            self::createMock(UserGroupRepository::class),
            self::createMock(PersistenceManager::class),
            self::createMock(SendMailService::class),
            self::createMock(FinisherRunner::class),
            self::createMock(LogUtility::class)
        );
    }
