...
$feUsersColumns = [
    ...
    'tx_femanager_confirmation_required' => [
        ...
        'config' => [
            'type' => 'check',
            'items' => [
                ['LLL:EXT:femanager/Resources/Private/Language/locallang_db.xlf:fe_users.confirmationRequired.user', ''],
                ['LLL:EXT:femanager/Resources/Private/Language/locallang_db.xlf:fe_users.confirmationRequired.admin', ''],
            ],
            'default' => 0,
        ],
    ],
