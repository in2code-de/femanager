...
$TCA['tx_femanager_domain_model_log'] = array(
    'ctrl' => array(
        ...
        'searchFields' => 'title',
        'dynamicConfigFile' =>
            \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('femanager') . 'Configuration/TCA/Log.php',
        'iconfile' =>
            \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('femanager') .
                'Resources/Public/Icons/Log.gif'
    ),
);
