...
.. code-block:: text
	...
	#			}
				...
				# possible validations for each field are: required, email, min, max, intOnly, lettersOnly, uniqueInPage, uniqueInDb, date, mustInclude(number,letter,special), inList(1,2,3), captcha, sameAs(password)
