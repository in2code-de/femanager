...
class User extends AbstractEntity
{
     ...
     * @var string
     */
    protected $txFemanagerSessionToken = '';

    /**
     * @var int
     */
    protected $txFemanagerSessionTokenExpiry = 0;
    ...
    public function getTxFemanagerSessionToken(): string
    {
        return $this->txFemanagerSessionToken;
    }

    public function setTxFemanagerSessionToken(string $txFemanagerSessionToken): void
    {
        $this->txFemanagerSessionToken = $txFemanagerSessionToken;
    }

    public function getTxFemanagerSessionTokenExpiry(): int
    {
        return $this->txFemanagerSessionTokenExpiry;
    }

    public function setTxFemanagerSessionTokenExpiry(int $txFemanagerSessionTokenExpiry): void
    {
        $this->txFemanagerSessionTokenExpiry = $txFemanagerSessionTokenExpiry;
    }
    ...
    {
        if (empty($this->txFemanagerSessionToken)) {
            return false;
        }

        if ($this->txFemanagerSessionTokenExpiry < time()) {
            return false;
        }
