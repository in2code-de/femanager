...
class ConfirmationRequiredUpdater implements UpgradeWizardInterface
{
    ...
    {
        return 'femanager_confirmationrequiredupdater';
    }
        ...
        return (int)$queryBuilder
            ...
            ->where(
                ...
                $queryBuilder->expr()->eq(
                    ...
                    $queryBuilder->createNamedParameter(User::CONFIRMATION_REQUIRED_NONE, PDO::PARAM_INT)
                )
            )
            ->execute()
            ->fetchColumn(0);
        ...
        $queryBuilder
            ...
            ->where(
                ...
                $queryBuilder->expr()->eq(
                    ...
                    $queryBuilder->createNamedParameter($confirmedByUser ? 1 : 0, PDO::PARAM_INT)
                ),
                $queryBuilder->expr()->eq(
                    'tx_femanager_confirmation_required',
                    $queryBuilder->createNamedParameter(User::CONFIRMATION_REQUIRED_NONE, PDO::PARAM_INT)
